...
const Signup = () => {
  ...
  const handleUserType = (
    ...
    const userTypeSelected = (e.target as HTMLUListElement).textContent || "";
    setSignUpDetails({
      ...signupDetails,
      userRole: userTypeSelected,
      ...
      <div className="rounded-sm  border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <Link to="/">
              <h1 className="text-white ml-10 font-semibold text-2xl w-44 pt-1 h-12 rounded-2xl text-center bg-blue-500">
                &lt;&nbsp;&nbsp;Home
              </h1>
            </Link>

            <div className="py-17.5 px-26 text-center ">
              <p className="2xl:px-20 text-2xl ">Welcome To MovieBooking App</p>
              ...
              <form>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute opacity-25 right-4 top-4">
                      <RiUserLine size={20} />
                    </span>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <details
                      className="dropdown  mb-4 w-full "
                      id="userTypeDropDown"
                    >
                      <summary className="w-full flex justify-between rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                        {!signupDetails.userRole
                          ? "User Type"
                          : signupDetails.userRole}
                        <span className="absolute opacity-25 right-4 top-4">
                      ...
                      <ul
                        ...
                        className=" cursor-pointer rounded border absolute z-10 border-stroke bg-gray py-3 pl-11.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary  "
                      >
                        <li>
                          <a>CUSTOMER</a>
                        </li>
